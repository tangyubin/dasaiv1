...
<div class="aw-register-box">
	...
	<div class="mod-body">
		<form class="aw-register-form" action="regist" method="post" id="register_form">				
			<ul>
                ...
                <li>
                	<select class="form-control" name="userType" tips="请选择一个用户身份" errortips="还未选择用户身份" onFocus="role_choose_tips()">
...
$(document).ready(function ()
{
		...
		$('#regist-submit').click(
			function(){
				...
				var rt = usernameValidity && passwordValidity && passwordConfirmValidity && emailValidity && roleValidity;
				return rt;
			}		
		);
